...
public abstract class DataSourceBase {
    ...
    public abstract void setMarket(String marketName, int marketNumber, int marketPos) throws Exception;
    public abstract void setQuote(String quoteName, int quoteNumber, int quotePos) throws Exception;
